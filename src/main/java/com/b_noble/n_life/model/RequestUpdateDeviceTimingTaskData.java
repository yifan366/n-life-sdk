...
public class RequestUpdateDeviceTimingTaskData {
	...
	public RequestUpdateDeviceTimingTaskData(byte timingId, String timingName, byte[] uid,
			TaskTimerAction taskTimerAction, byte switchState, byte brightness, byte hue, byte saturation,
			byte colorTemperature, byte isenable) {
		super();
